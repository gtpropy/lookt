"""
Django settings for looktvps project.
...
SECRET_KEY = 'django-insecure-!qtl^yt2a=acd5f5lsajz5i952oubcah=%m@7e2$5j7*g*8maa'
...
WSGI_APPLICATION = 'looktvps.wsgi.application'
